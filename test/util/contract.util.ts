...
import { WorkToken, TokenDistribution, GenesisNft, RewardShares, RewardTokens } from "../../typings";
...
import { regenerateRewardShares, regenerateRewardTokens } from "./rewards.util";
