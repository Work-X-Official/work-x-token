...
abstract contract Reward is Ownable, IRewarder {
    ...
    /**
     * @notice Calculates the reward of nftId for a specific month based on the total rewards of this month
    ...
    function getRewardNftIdMonth(
        uint256 _nftId,
        uint256 _month
    ) public view virtual returns (uint256 _rewardNftIdMonth);
