...
describe.only("GenesisNftUpdateMonthlyPrivate", () => {
  let nft: GenesisNft;
  ...
  describe("Private Functions: Update monthly staking balances for a tokenId", async () => {
    ...
    describe.only("More update monthly test, including all cases 1 smaller, equal, and larger in the if statements", async () => {
      let nftMinter1: SignerWithAddress;
      let nftMinter2: SignerWithAddress;
